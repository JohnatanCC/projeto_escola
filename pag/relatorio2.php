        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header bg-warning">
                <h3 class="card-title">Itens acabando</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
              if (isset($_POST['addQuantidade'])) {
                ...
                header("Location: home.php?acao=relatorio2");
                exit();
            ...
            $select = "SELECT * FROM estoque_alimento where qtd_alimento <= 3  ORDER BY id_alimento";
