        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header bg-red">
                <h3 class="card-title">Itens faltando</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
              if (isset($_POST['addQuantidade'])) {
                ...
                header("Location: home.php?acao=relatorio3");
                exit();
            ...
            $select = "SELECT * FROM estoque_alimento where qtd_alimento <= 0 ORDER BY id_alimento";
              ...
              if ($contar > 0) {
                while ($show = $result->FETCH(PDO::FETCH_OBJ)) {   
                  ...
                  <?php
                      ...
                      echo '<div class="alert  text-center mb-2 alert-warning" role="alert"><sytrong>Ainda não há alimentos adicionados ou não estão faltando!<strong></div>';
                    }
